...
_PLAYWRIGHT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SelectFrame',
    full_name='Playwright.SelectFrame',
    index=4,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='DeselectFrame',
    full_name='Playwright.DeselectFrame',
    index=5,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_RESPONSE_EMPTY,
