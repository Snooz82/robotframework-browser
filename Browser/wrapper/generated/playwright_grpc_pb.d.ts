...
interface IPlaywrightService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    selectFrame: IPlaywrightService_ISelectFrame;
    deselectFrame: IPlaywrightService_IDeselectFrame;
...
interface IPlaywrightService_ISelectFrame extends grpc.MethodDefinition<playwright_pb.selectorRequest, playwright_pb.Response.Empty> {
    path: string; // "/.Playwright/SelectFrame"
    requestStream: boolean; // false
    responseStream: boolean; // false
...
interface IPlaywrightService_IDeselectFrame extends grpc.MethodDefinition<playwright_pb.Empty, playwright_pb.Response.Empty> {
    path: string; // "/.Playwright/DeselectFrame"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<playwright_pb.Empty>;
    requestDeserialize: grpc.deserialize<playwright_pb.Empty>;
...
export interface IPlaywrightServer {
    ...
    selectFrame: grpc.handleUnaryCall<playwright_pb.selectorRequest, playwright_pb.Response.Empty>;
    deselectFrame: grpc.handleUnaryCall<playwright_pb.Empty, playwright_pb.Response.Empty>;
...
export interface IPlaywrightClient {
    ...
    selectFrame(request: playwright_pb.selectorRequest, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    selectFrame(request: playwright_pb.selectorRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    selectFrame(request: playwright_pb.selectorRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectFrame(request: playwright_pb.Empty, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectFrame(request: playwright_pb.Empty, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectFrame(request: playwright_pb.Empty, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
...
export class PlaywrightClient extends grpc.Client implements IPlaywrightClient {
    ...
    public selectFrame(request: playwright_pb.selectorRequest, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public selectFrame(request: playwright_pb.selectorRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public selectFrame(request: playwright_pb.selectorRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectFrame(request: playwright_pb.Empty, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectFrame(request: playwright_pb.Empty, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectFrame(request: playwright_pb.Empty, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
